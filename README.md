...
1. [TOPページ](https://shrimp1228.github.io/typing2/)にアクセスし、**SPACEキー**を押すとタイピングページに移動します。
1. タイピングページにアクセスすると、ランダムでお題が表示されます
2. 表示されたテキストを正確にタイピングしてください
3. 完了すると統計情報（KPM、CPM、タイム、削除回数）が表示されます
4. **ESCキー**を押すと、新しいお題に変更できます
